...
/**
 * Definition of ObjectType UserConvenienceLog.
 *
 * @since 2020-09-29
 */
public class UserConvenienceLog extends CloudDBZoneObject {
    @PrimaryKey
    private String id;
    ...
    public void setConvenienceid(String convenienceid) {
